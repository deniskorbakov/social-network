...
let dialogsElement = dialogs.map( d => <DialogItem id={d.id} name={d.name} message={d.message}/>);
let messagesElement = messages.map( m => <Message name={m.name} message={m.message}/>)
